...
void Bitacora::Colisiones(){
  std::cout<<"Numero total de colisiones: "<<grafo.colisiones()<<std::endl;
}
void Bitacora::getIPSummary_Bitacora(std::string ip){
  grafo.getIPSummary(ip);
}